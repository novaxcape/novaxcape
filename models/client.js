  ...
  class Client extends Model {
    ...
    static associate(models) {
      // define association here
        ...
        Client.hasMany(models.Payment, { foreignKey: 'clientId', as: 'payments'});
        Client.hasMany(models.favourite, { foreignKey: 'clientId', as: 'favourites'});
    }
  }
  Client.init({
    id: {
    ...
    profilePicture: {
      ...
      set(val) {
        this.setDataValue('profilePicture', val);
      }
    },
    profilePicturePublicUrl: {
      ...
      set(val) {
        this.setDataValue('profilePicturePublicUrl', val);
      }
    },
    role: {
      type: DataTypes.STRING,
