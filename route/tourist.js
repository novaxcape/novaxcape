...
router.post('/register/:vendorId', authenticateToken, vendorAuth, upload.fields([
...
router.post('/verify-client-passcode', authenticateToken, vendorAuth, touristController.verifyClientPasscode)
